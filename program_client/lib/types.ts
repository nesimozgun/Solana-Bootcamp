...
export interface VideoNftMetadata {
  videoUrl: string;
  publisher: string;
  category: string;
  mint: PublicKey;
...
export const decodeVideoNftMetadata = (decoded: Decoded): VideoNftMetadata => ({
    videoUrl: decoded["video_url"] as string,
    publisher: decoded["publisher"] as string,
...
export const VideoNftMetadataSchema: Schema =  {
    struct: {
        video_url: "string",
        publisher: "string",
        category: "string",
